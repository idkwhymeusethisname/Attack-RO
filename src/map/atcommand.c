...
ACMD_FUNC(oasis1428) {
        ...
        nullpo_retr(-1, sd);
				...
				clif_displaymessage(fd, "@oasis1428 is not allowed on this map.");
				return 0;
				}
				...
				if( pc_isdead(sd) ) {
				clif_displaymessage(fd, "Cannot @oasis if you are dead.");
				return -1;
				}
                ...
                return -1;}
                        ...
                        skill_sit(sd,1);
                        clif_sitting(&sd->bl);
						 clif_changelook(&sd->bl,LOOK_HEAD_TOP,32030);
